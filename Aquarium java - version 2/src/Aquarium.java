...
public class Aquarium extends JFrame {
	...
	public void addContents() {
		...
		dPanel.addDrawableItem(new Fish(dPanel, "Clownfish.gif", 11, false));
		dPanel.addDrawableItem(new Fish(dPanel, "PezTropical.gif", 5, true));
		dPanel.addDrawableItem(new Fish(dPanel, "tropical.gif", 10, true));
		...
		dPanel.addDrawableItem(new Bubble(dPanel, 50, 6));
		dPanel.addDrawableItem(new Bubble(dPanel, 55, 5));
		dPanel.addDrawableItem(new Bubble(dPanel, 81, 3));
		dPanel.addDrawableItem(new Bubble(dPanel, 29, 4));
